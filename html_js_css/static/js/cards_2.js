...
async function createInstances() {
    ...
    const d_1018 = document.createElement('div');
    d_1018.id = 'd_1018';
    ...
    const d_1014 = document.createElement('div');
    d_1014.id = 'd_1014';
    ...
    const svetly = document.createElement('div');
    svetly.id = 'svetly';
    ...
    const pervouralsk = document.createElement('div');
